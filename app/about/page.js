    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            Our {number.length} luxury cabins provide a cozy base, but the real freedom and
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <div>
            <Link
              href="/cabins"
          className="bg-accent-600 rounded-md px-8 py-6 text-primary-950 text-lg font-semibold  hover:text-primary-200 duration-1000 hover:text-2xl hover:bg-accent-600/15  "
            >
